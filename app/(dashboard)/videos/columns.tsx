...
import { VideoItemType } from "./schema";
...
const Action = ({ row }: CellContext<VideoItemType, unknown>) => {
...
export const videoColumns: ColumnDef<VideoItemType>[] = [
  {
    accessorKey: "id",
    header: "ID",
    cell: ({ row }) => {
