...
import { patchMerchandiseAttributeValues } from '../actions';
import {
...
export function UpdateDialog({
  ...
  children: ReactNode;
  initialData: MerchandiseAttributeValuesItemType;
}) {
  ...
  function onSubmit({ status, ...values }: MerchandiseAttributeValuesBodyType) {
    startTransition(() => {
      patchMerchandiseAttributeValues({
        ...values,
        id: initialData.id,
  ...
  return (
    <FormDialog
      ...
      onSubmit={onSubmit}
      loading={isPending}
      title="Update MerchandiseAttributeValues"
      submitText="Update"
      trigger={children}
    >
      <FormField
