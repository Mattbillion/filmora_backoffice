...
import { ItemBodyType, ItemItemType, itemSchema } from "../schema";
...
export function UpdateDialog({
  ...
  const form = useForm<ItemBodyType>({
    ...
    defaultValues: {
      ...
      status: initialData.status.toString() as ItemBodyType["status"],
  ...
  if (!hasPermission(role, "trainings.items", "update")) return null;
  return (
    <FormDialog
      ref={dialogRef}
      form={form}
